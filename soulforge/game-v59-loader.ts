...
Object.assign(CARD_DEFS,{
 ...
 offerta_maligna:{id:'offerta_maligna',name:'Offerta Maligna',color:'black',cost:0,speed:'base',type:'Magia',text:'Scegli un Mostro, poi il tuo avversario sceglie un altro Mostro. Ogni giocatore uccide il Mostro che ha scelto.',effect:'v59_offerta'},
 scambio_di_anime:{id:'scambio_di_anime',name:'Scambio di Anime',color:'black',cost:2,speed:'instant',type:'Magia',text:'Istantanea. Scegli due Campioni. Scambia il loro POW fino alla fine del turno.',effect:'v59_scambio'},
