...
const baseRender=render;render=function(){baseRender();ensureUi();bindPreview();{const version=session.version,room=session.room;setTimeout(()=>{if(session.room===room&&session.version===version)autoPass()},80)}};
