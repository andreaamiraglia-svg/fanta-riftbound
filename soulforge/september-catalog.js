export const cards = [
 ...
 ['furia_del_ferito','Furia del Ferito','red',3,'response','own','Scegli un tuo Campione. Per questo turno, ogni volta che subisce danni e sopravvive, ottiene Carica 4.'],
...
].map(([id,name,color,cost,speed,target,text])=>({id,name,color,cost,speed,target,text,type:'Magia',effect:'september_'+id,art:id.replaceAll('_','-')+'.webp'+(id==='furia_del_ferito'?'?rev=charge4-20260917':'')}));
