...
function artUrl(id){if(String(id)==='richiamo_del_branco')return 'https://raw.githubusercontent.com/andreaamiraglia-svg/fanta-riftbound/main/champion-of-the-souls-carte-ottimizzate/cards/richiamo-del-branco-nero.webp';return ART[id]?BASE+ART[id]:''}
